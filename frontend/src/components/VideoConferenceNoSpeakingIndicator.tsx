...
export interface VideoConferenceNoSpeakingIndicatorProps extends React.HTMLAttributes<HTMLDivElement> {
...
export function VideoConferenceNoSpeakingIndicator({
  chatMessageFormatter,
  chatMessageDecoder,
  chatMessageEncoder,
  SettingsComponent,
  ...props
}: VideoConferenceNoSpeakingIndicatorProps) {
